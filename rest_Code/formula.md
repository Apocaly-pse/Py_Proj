...
5. $$
    \int{\ln \left( \sqrt{1+x}+\sqrt{1-x} \right) \text{dx}} 
    $$
...
10. $$
    \int{\frac{\text{d}x}{\sec x+\csc x+\cot x+\tan x}} 
    $$

11. $$
    \int{x^4\sqrt{\frac{1-x}{1+x}}\text{d}x} 
    $$

12. $$
    \int{x\sqrt[4]{\frac{1-x}{1+x}}\text{d}x}
    $$
...
24. $$
    \int{\frac{x^2\ln x}{\left( x^2+1 \right) ^{\frac{3}{2}}}\text{d}x} 
    $$

25. $$
    \int{\frac{x^2}{\left( x\sin x+\cos x \right) ^2}\text{d}x} 
    $$

26. $$
    \int{\frac{2x+\sin 2x}{\left( \cos x-x\sin x \right) ^2}\text{d}x} 
    $$
...
35. $$
    \int{\frac{\cos \left( \sin t \right) +\cos ^2t}{1+\sin t\sin \left( \sin t \right)}\text{d}x} 
    $$
...
40. $$
    \int{\frac{x^2\text{d}x}{\left( x^2-4 \right) \sin x+4x\cos x}} 
    $$
...
44. $$
    \int{\frac{\cos 2x-\tan x\cdot \cot \left( \tan x \right)}{\sin 2x-\tan \left( \tan x \right) \ln \left( \cos ^2x \right)}\text{d}x} 
    $$
...
47. $$
    \int{\frac{\cos x\text{d}x}{\sqrt{2+\sin 2x}}} 
    $$
...
54. $$
    \int{\frac{\left( \sin x+1 \right) ^2+x\cos x}{\left( x\sin x-\cos x \right) ^2}\text{d}x} 
    $$
...
57. $$
    \int{\frac{\tan x-\cos x}{\left( 2+e^{\sin x}\cos x \right) ^2}\text{d}x} 
    $$
...
61. $$
    \int{\frac{x-2}{\sqrt{e^x-x^2}}\text{d}x} 
    $$

62. $$
    \int{\frac{\text{dx}}{\left( 1+x\tan x \right) ^2}}
    $$
...
64. $$
    \int{\frac{\cos x\left( 2020x+2019\sin x\cos x \right)}{\left( x\sin x+\cos x \right) ^3}\text{d}x} 
    $$

65. $$
    \int{e^{x\sin x+\cos x}\left[ \frac{x^4\cos ^3x-x\sin x+\cos x}{x^2\cos ^2x} \right]}\text{d}x 
    $$

66. $$
    \int{\frac{\left( x+1 \right) e^x}{\sqrt{a^2-e^x}}\text{d}x} 
    $$
...
73. $$
    \int{\frac{\text{d}x}{\left( 1+\sin x \right) ^n}} 
    $$
...
77. $$
    {\int{\text{arctan}\frac{x^3-x^2-4x-1}{x^3+4x^2+x-1}\text{d}x}}
    $$
...
79. $$
    \int{\frac{x^4-1}{x^8+1}\sqrt{1+x^4}\text{d}x} 
    $$
...
87. $$
    \int{\frac{\frac{\ln x}{x}+\ln ^2x}{e^{-2x}+\ln ^2x}\text{d}x} 
    $$
...
92. $$
    \int{\sqrt{\frac{x+\sqrt{x}}{x-\sqrt{x}}}}\text{d}x  
    $$
...
99. $$
    \int{\frac{\sin x\cos x}{\sqrt{a^2\sin ^2x+b^2\cos ^2x}}\text{d}x} 
    $$
...
104. $$
    \int{\frac{1}{\sqrt{2}+\sqrt{1-x}+\sqrt{1+x}}\text{d}x} 
    $$
...
106. $$
    \int{\frac{\text{d}x}{\sqrt{\left( x+x^{-1} \right) ^2-12}}} 
    $$

107. $$
    \int{\frac{x\left( 2-x \right) e^x\cos 2x+e^{2x}-x^4}{\left( e^x\cos x+x^2\sin x \right) \sqrt{x^4-e^{2x}}}\frac{\text{d}x}{\sqrt{\cos 2x}}} 
    $$
...
111. $$
    \int{x\left[ \frac{1}{x} \right] \text{d}x} 
    $$

112. $$
    \int{\left[ x \right] |\sin \pi x|\text{d}x} 
    $$

113. $$
    \int{\frac{x\left( x^2+x\tan x+1 \right)}{\left( x\tan x-1 \right) ^2}\text{d}x} 
    $$
...
117. $$
    \int{\frac{x\text{d}x}{2\left( \sec x+\tan x \right) -\cos x}} 
    $$
...
130. $$
    \int{\frac{\exp \left\{ 1/\ln x \right\}}{x\ln ^3x}\text{d}x} 
    $$

131. $$
    \int{\frac{x+x^{-1}+1}{\sqrt{\left( x^2+x-1/3 \right) ^2+4x/3}}\text{d}x} 
    $$

132. $$
    \int{\frac{x^n\text{d}x}{\sqrt{\sum_{k=0}^n{\left( k+1 \right) x^k}}}} 
    $$

133. $$
    \int{\frac{2n!\sin x+x^n}{e^x+\sin x+\cos x+\displaystyle\sum_{k=0}^n{\frac{x^k}{k!}}}}\text{d}x 
    $$
